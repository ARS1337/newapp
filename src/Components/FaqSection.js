      ...
      <div className="w-full overflow-hidden ">
        <Accordion sx={{}} defaultExpanded={true}>
          ...
          <AccordionDetails style={{padding:0}}>
            <Typography>
              <SimpleAccordion heading="Lorem ipsum dolor sit amet" defaultExpanded={true} border={true} headingTextStyle="text-xl font-Poppins-SemiBold" childrenTextStyle="font-Poppins-Regular text-lg px-4 pb-4 border border-gray-300 border-b-0 border-l-0 border-r-0 pt-4">
