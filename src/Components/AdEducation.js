...
function AdEducation(props) {
    return (
        <div className="bg-adedu bgimgcard w-full bg-cover bg-no-repeat bg-center p-3 flex items-center justify-center flex-col text-white rounded-xl mb-6 bg-black bg-opacity-100 drop-shadow-lg">
        <label className="pb-6 text-lg text-white mt-4">Education</label>
