  ...
  return (
    <div className="bg-black-custom md:px-4 lg:px-24 py-12 flex flex-col whitespace-nowrap">
      <div className="flex flex-col md:flex-row justify-between ">
        <div className="text-white w-full md:w-6/12 lg:w-5/12 flex flex-row  justify-between mr-24 ">
      ...
      <div className="flex flex-row justify-center   mt-12">
        <div className="text-white  w-8/12 flex flex-row items-center justify-start mr-24 font-Poppins-Medium ">
      ...
      <div className=" mt-16 flex flex-col md:flex-row justify-between items-center ">
        <div className="text-white flex flex-row items-center justify-start mr-24   w-5/12">
          <label className="flex justify-start text-lg font-Poppins-Medium">© 2020 Sea & Beyond. All Rights Reserved</label>
        </div>
        <div className="text-white w-5/12 md:w-3/12 flex flex-row  justify-between mt-4 md:mt-0">
