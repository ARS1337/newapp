  ...
  return (
    <div className="w-full mt-8">
      <div className="flex items-center justify-center flex-col">
        ...
        <div className="bg-slate-300 w-full my-8 rounded-lg"><ComparisionTable/></div>
        <div className="flex flex-row items-center justify-around w-full bg-green-custom rounded-lg drop-shadow-lg p-2">
            ...
            <button className="flex flex-row bg-white p-1 items-center px-2 md:p-3 md:px-5 rounded-lg"><label className="text-green-custom font-Poppins-SemiBold pr-1 md:pr-4">Contact us</label><img src='/assets/ThirdPage/arrow-right.png' alt="contact us button"/></button>
        </div>
            <TestimonialContainer autoScroll={true} key="comparison" id="comparison" heading={false}>
            {data.testimonials.map((testimonial, key) => {
                return (
                  <div key={"comparison"+key} className="mx-4 w-[300px] lg:w-[600px]  flex items-center justify-center">
